...
class TestGateAnalysis(unittest.TestCase):
    def test_arm_parsing_controls_and_evidence_tiers(self):
        ...
        self.assertEqual(control_arm("h-sincos"), "h-finalist1")
        self.assertEqual(control_arm("f-gain"), "f-alpha02")
        self.assertEqual(control_arm("t-pooled"), "t-perorbit")
        self.assertEqual(control_arm("d-pooled"), "d-perorbit")
        self.assertEqual(control_arm("a-phase"), "d-pooled")
        self.assertEqual(control_arm("c-stem-on"), "c-stem-off")
