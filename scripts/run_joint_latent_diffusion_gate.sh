...
OUTPUT_DIR="${OUTPUT_DIR:-${ROOT}/latent_continuous_runs/joint-vae-mean-rf-w768-l12-b256-s1-n30000}"

exec /venv/main/bin/python "${ROOT}/train_joint_latent_diffusion.py" \
  ...
  --preview_steps 2500 \
  --run_name joint-latent-diffusion-vae-mean-rf-w768-l12-b256-s1-n30000 \
  "$@"
