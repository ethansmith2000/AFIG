#!/usr/bin/env bash
# Larger-sample follow-up for a qualifying grouped-hierarchy arm.
set -euo pipefail
...
case "$1" in
  cumulative)
    name="v32-residual-e7p1-det-jitter05-slotbal2e3-hier-cum3e2-n64d16-s2-prior-s1"
    ;;
  innovation)
    name="v33-residual-e7p1-det-jitter05-slotbal2e3-hier-innov23e3-n64d16-s2-prior-s1"
    ;;
esac
...
echo "GROUPED HIERARCHY 10K $1 COMPLETE $(date -u +%FT%TZ)"
