#!/usr/bin/env bash
# Larger-sample follow-up for a qualifying slot-balance seed replication.
set -euo pipefail
...
seed="${1#s}"
name="v27-residual-e7p1-det-jitter05-slotbal2e3-n64d16-s${seed}-prior-s1"
...
echo "SLOT BALANCE REPLICATION 10K $1 COMPLETE $(date -u +%FT%TZ)"
